$(function () {
    ...
    $('#tblSkills').on('click', '.btnSkillDetail', function () {
        var row = $(this).parents('tr');
        var id = row.attr('id');
    });
    //End JS skill
